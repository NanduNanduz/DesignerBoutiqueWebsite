...
//     // Optionally check if enough stock is available (if you have stock data)
...
//     // Return only the updated cart items (instead of entire cart object)
//     res.status(200).json({
//       message: "Product added to cart successfully",
//       cart: user.cartData.items, // Only send the cart items
//     });
//   } catch (error) {
...
// // Corrected route for fetching the cart list
// router.get("/cartlist", verifyToken, async (req, res) => {
//   try {
//     const userId = req.user.id; // Assuming authentication middleware sets req.user
//     const user = await userModel.findById(userId).populate("cartData.items.productId");
